...
//        tShirtRepository.deleteAll();
    ...
    public void shouldAddFindDeleteInvoice() {
        ...
        GraphicsContext tShirtRepository = null;
//        tShirt1 = tShirtRepository.save(getTShirt1(tShirt1));
    ...
    private TShirt getTShirt1(TShirt tShirt1) {
        return tShirt1;
    }
    ...
    public void shouldFindByName() {
        ...
        tShirt1.setQuantity(8);
        ValueWrapper tShirtRepository = null;
       // tShirt1 = tShirtRepository.create(tShirt1);
